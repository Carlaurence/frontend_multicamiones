        ...
        <div className="overflow-hidden flex flex-col bg-gradient-to-r from-black via-gray-400 to to-white">
            ...
            <div className="flex flex-col md:min-h-screen">
                ...
                {truck && (
                    ...
                    /*PANTALLA MD: Y LG:*/
                    <div className="flex flex-col gap-4 w-full md:min-h-screen mt-32 pl-10 pr-10">

                        {/**DIV SUPERIOR*/}
                        <div className="flex h-[10vh] p-2 w-full mt-4 bg-slate-200 border-[2px] border-white">

                            <div className="flex w-[50%] h-full">
                                <h1 className="font-bold text-[22px] text-red-800">{truck.year + " " + truck.make + " " + truck.model}</h1>
                            </div>

                            <div className="flex justify-end w-[50%] h-full black/40">
                                <h1 className="font-bold text-[22px] text-red-800">{formatterPesoCOP.format(truck.price) + " COP"}</h1>
                            </div>
                        ...
                        <div className="flex flex-row w-full">
                            ...
                            <div className="flex flex-col items-end w-[35%] h-full ">

                                <div className="flex flex-col gap-4 w-[90%] p-2 bg-slate-200 border-[2px] border-white">
                                    ...
                                    <div className="flex items-center justify-center w-full">
                                        <button disabled={expand ? true : false} onClick={() => setExpand(true)} className={` w-[260px] font-semibold text-white rounded-md bg-red-800 hover:bg-red-900 hover:text-gray-400 active:bg-red-800 active:text-white uppercase`}>Calcular Financiacion</button>
                                    </div>
                                    ...
                                    <div className="button flex items-center justify-center w-full">
                                        <Link type="button" target="_blank" to={`https://wa.me/573187825631?text=Estoy%20interesado%20en%20el%20camion`} style={{ background: '#25d366' }} className={`flex justify-center w-[260px] font-semibold text-white rounded-md uppercase`}><FaWhatsapp style={{ color: 'white', fontSize: '25px' }} />Contactar un Asesor</Link>
                                    </div>
