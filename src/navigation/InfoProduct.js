                            ...
                            <div className="flex flex-col items-end w-[100%] md:w-[35%] h-full ">
                                ...
                                <div className="flex flex-col gap-4 w-[100%] md:w-[90%] p-2 lg:p-4 bg-slate-200 border-[2px] border-white">
                                    ...
                                    <div className="button flex items-center justify-center w-full">
                                        <Link type="button" target="_blank" to={`https://wa.me/${process.env.REACT_APP_WHATSAPP_LINK}?text=${process.env.REACT_APP_HOST_URL+location.pathname}`} className={`flex justify-center items-center w-[260px] h-7 text-sm md:text-xs lg:text-sm font-semibold text-white bg-green-500 hover:bg-green-600 hover:text-gray-400 active:bg-green-500 active:text-white rounded-md uppercase`}><FaWhatsapp style={{ color: 'white', fontSize: '20px' }} />&nbsp;Contactar un Asesor</Link>
                                    </div>
